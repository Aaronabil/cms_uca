    ...
    return (
        <GuestLayout>
            <div ref={containerRef} className="relative h-screen w-full overflow-hidden bg-green-800 text-white">
                ...
                <div className="absolute inset-0 z-0 bg-gradient-to-t from-orange-600/80 to-transparent" />
                ...
                <div className="relative z-10 flex h-full flex-col justify-between p-8 md:p-12 lg:p-16">
                    ...
                    <div className="mb-12 max-w-4xl">
                        <h1 className="flex flex-col text-6xl font-bold leading-tight tracking-tighter md:text-8xl lg:text-9xl">
                            <span>Fakultas</span>
                            <span className="font-light">Teknik</span>
                        </h1>
                    </div>
            ...
            <section className="bg-white py-24 text-gray-900">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                        <div>
                            <h2 className="text-3xl font-bold tracking-tight text-orange-500/80 sm:text-4xl mb-6">
                                Tentang Fakultas
                            </h2>
            ...
            <section className="bg-orange-600/95 py-24 text-white">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <Link href="/akademik/fakultas/febi/sarjana">
                            <div className="group relative h-60 rounded-3xl border border-white/20 bg-orange-500 p-8 transition-colors hover:border-white/90 flex flex-col justify-between">
            ...
            <div ref={containerRef} className="relative h-screen w-full overflow-hidden">
                ...
                {/* Overlay for better text readability if needed, though image is green */}
                <div className="absolute inset-0 z-0 bg-gradient-to-t from-orange-500/60 to-transparent" />
            </div>
        </GuestLayout>
    )
}
